            ...
            {!! Form::open(array('id'=>'', 'class'=>'form-horizontal form-validate','method'=>'post')) !!}
              ...
              <div class="col-md-12">         
                <div class="form-group">
                  ...
                  <div class="col-sm-12 col-md-9 col-lg-10">
                    ...
                    {!! Form::text('title['.$lang->code.']', $details->translate($lang->code)->title, array('class' => 'form-control required '.(($lang->code == 'ar')? 'arbic_lang':'')  ,'id'=>'','placeholder'=>'Title')) !!}
                  </div>
                </div>
                ...
                <div class="form-group textares">
                  ...
                  <div class="col-sm-12 col-md-9 col-lg-10">
                    ...
                    {!! Form::textarea('description['.$lang->code.']', $details->translate($lang->code)->description, array('class' => 'summernote '.(($lang->code == "ar")?" arbic_lang":"summernote")  ,'id'=>'','placeholder'=>'Description')) !!}
                  </div>
                </div>                
                </div>  
                ...
                <div class="form-group textares">
                  ...
                  <div class="col-sm-12 col-md-9 col-lg-10">
                    ...
                    {!! Form::textarea('short_description['.$lang->code.']', $details->translate($lang->code)->short_description, array('class' => ''.($lang->code == "ar")?"arbic_lang":""  ,'id'=>'','placeholder'=>'Short Description')) !!}
                  </div>
                </div>                
                </div>                               
                </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-10">                    
                    {!! Form::text('page_name', $details->page_name, array('class' => 'form-control required','id'=>'','placeholder'=>'Page Name')) !!}
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-10">
                    ...
                    {!! Form::text('meta_title', $details->meta_title, array('class' => 'form-control ','id'=>'','placeholder'=>'Meta Title')) !!}
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-10">                    
                    {!! Form::text('meta_key', $details->meta_key, array('class' => 'form-control ','id'=>'','placeholder'=>'Meta Key')) !!}
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-10">                   
                    {!! Form::textarea('meta_description', $details->description, array('class' => 'form-control','id'=>'','placeholder'=>'Meta Description')) !!}
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-10">
                    ...
                    {!! Form::select('status', array('Active' => 'Active', 'Inactive' => 'Inactive'),$details->status, array('class' => 'form-control required','id'=>'')) !!}
