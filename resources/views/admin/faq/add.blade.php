            ...
            {!! Form::open(array('id'=>'', 'class'=>'form-horizontal form-validate','method'=>'post')) !!}
              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-6">
                    {!! Form::select('category', $faqCategories, '', array('class' => 'form-control required','id'=>'','placeholder'=>'Category')) !!}
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                      {!! Form::text('question['.$lang->code.']', '', array('class' => 'form-control  required'.(($lang->code == 'ar')? ' arbic_lang':''),'id'=>'','placeholder'=>'Question')) !!}
                    </div>
                  </div>                  
                  </div>  
                  ...
                  <div class="form-group textares">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                      {!! Form::textarea('answer['.$lang->code.']', '', array('class' => 'required'.(($lang->code == 'ar')? ' arbic_lang':''),'id'=>'','placeholder'=>'Answer')) !!}
                    </div>
                  </div>                    
              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-6">
                    {!! Form::select('status', ['Active'=>'Active','Inactive'=>'Inactive'], '', array('class' => 'form-control required','id'=>'')) !!}
                    <i class="fa fa-caret-down" aria-hidden="true"></i>
                  </div>
                </div>               
                </div>
