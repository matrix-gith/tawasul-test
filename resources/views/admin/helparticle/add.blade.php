              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-6">
                    {!! Form::select('category', $helparticleCategories, '', array('class' => 'form-control required','id'=>'','placeholder'=>'Category')) !!}
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group textares">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                      {!! Form::textarea('description['.$lang->code.']', '', array('class' => 'required'.(($lang->code == 'ar')? ' arbic_lang':''),'id'=>'','placeholder'=>'Description')) !!}
                    </div>
                  </div>                    
