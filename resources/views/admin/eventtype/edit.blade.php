          ...
          <div class="box box-info new-ticket">
            ...
            {{ csrf_field() }}
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-10">
                    <input type="text" class="form-control required @if($lang->code == 'ar') arbic_lang @endif" name="name[{{ $lang->code }}]" value="{{ $details->translateOrNew($lang->code)->name }}"  placeholder="Event Type Name" required="required">
                  </div>
                </div>                  
                ...
                <div class="form-group">
                  <label for="code" class="col-sm-3 col-md-3 col-lg-2 control-label">Color <span>*</span></label>

                  <div class="col-sm-9 col-md-9 col-lg-10">
                      <input class="form-control jscolor" name="color" id="color" value="{{ $details->color }}">
                  </div>
                </div>
              ...
              <div class="box-footer">
                <a class="btn btn-default" href="{{ URL::Route('eventtype_list') }}">Cancel</a>
