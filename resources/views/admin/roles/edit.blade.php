              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-10">
                    {!! Form::text('display_name', $record->display_name, array('class' => 'form-control required','id'=>'','placeholder'=>'Role')) !!}
                  </div>
                </div>                  
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-10">
                    {!! Form::text('description', $record->description, array('class' => 'form-control required','id'=>'','placeholder'=>'Description')) !!}
                  </div>
                </div>                  
                </div>                
