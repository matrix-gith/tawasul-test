            ...
            {!! Form::open(array('id'=>'', 'class'=>'form-horizontal form-validate','method'=>'post')) !!}
              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-6">
                    {!! Form::select('template_file', $templateFiles, $record->template_file, array('class' => 'form-control required','id'=>'','placeholder'=>'Template File')) !!}
              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-6">
                    {!! Form::text('slug', $record->slug, array('class' => 'form-control  required','id'=>'','placeholder'=>'Slug')) !!}
                  </div>
                </div>               
                </div>
                </div> 
              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-6">
                    {!! Form::text('template_name', $record->template_name, array('class' => 'form-control  required','id'=>'','placeholder'=>'Name')) !!}
                  </div>
                </div>               
                </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-6">
                    {!! Form::text('email_subject', $record->email_subject, array('class' => 'form-control  required','id'=>'','placeholder'=>'Subject')) !!}
                  </div>
                </div>               
                </div>
                </div> 
              ...
              <div class="row">
                ...
                <div class="form-group">
                   ...
                   <div class="col-sm-9 col-md-9 col-lg-10">                    
                    {!! Form::text('template_variables', $record->template_variables, array('class' => 'form-control  required','id'=>'','placeholder'=>'Template Variables')) !!}
                  </div>
                </div>               
                </div>
                </div>                                                                                                
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group textares">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                      {!! Form::textarea('email_content['.$lang->code.']', $record->translate($lang->code)->email_content, array('class' => 'summernote required'.(($lang->code == 'ar')? ' arbic_lang':''),'id'=>'','placeholder'=>'Content')) !!}
                    </div>
                  </div>                    
