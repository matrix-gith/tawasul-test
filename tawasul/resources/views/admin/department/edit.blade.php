              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-10">
                    <input type="text" class="form-control" name="code" id="code" placeholder="Department Code" value="{{ $details->code }}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-10">
                    <input type="text" class="form-control required @if($lang->code == 'ar') arbic_lang @endif"  name="name[{{ $lang->code }}]" value="{{ $details->translateOrNew($lang->code)->name }}"  placeholder="Department Name" required="required" @if($lang->code == 'en') readonly="readonly" @endif >
                  </div>
                </div>                  
               ...
               <div class="col-md-6">
                ...
                <div class="form-group">
                  <label for="code" class="col-sm-3 col-md-3 col-lg-2 control-label">In Ticket </label>
                  <div class="col-sm-9 col-md-9 col-lg-10">
                    <input type="checkbox" name="in_ticket" id="in_ticket"  value="1"  @if($details->in_ticket == 1) checked @endif>
                  </div>
                </div>
                </div>
