              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-6">
                    {!! Form::select('category', $helparticleCategories, $record->helparticle_category_id, array('class' => 'form-control required','id'=>'','placeholder'=>'Category')) !!}
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-12">              
                  <div class="form-group">
                    <label for="name" class="col-sm-3 col-md-3 col-lg-2 control-label">Title <span>*</span></label>
                    <div class="col-sm-9 col-md-9 col-lg-10">
                      {!! Form::text('title['.$lang->code.']', $record->translate($lang->code)->title, array('class' => 'form-control  required'.(($lang->code == 'ar')? ' arbic_lang':''),'id'=>'','placeholder'=>'Title')) !!}
                    </div>
                  </div>                  
                  </div>  
                  ...
                  <div class="form-group textares">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-10">
                      {!! Form::textarea('description['.$lang->code.']', $record->translate($lang->code)->description, array('class' => 'required'.(($lang->code == 'ar')? ' arbic_lang':''),'id'=>'','placeholder'=>'Description')) !!}
                    </div>
                  </div>                    
