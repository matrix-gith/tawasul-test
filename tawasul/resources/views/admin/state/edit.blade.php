            ...
            {{ csrf_field() }}
              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-10">
                    <input type="text" class="form-control" name="code" id="code" placeholder="State Code" required="required" value="{{ $details->state_code }}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-md-9 col-lg-10">
                    <input type="text" class="form-control required @if($lang->code == 'ar') arbic_lang @endif" name="name[{{ $lang->code }}]" value="{{$details->translateOrNew($lang->code)->name }}"  placeholder="State Name" required="required">
                  </div>
                </div>
                @endforeach
               </div>
